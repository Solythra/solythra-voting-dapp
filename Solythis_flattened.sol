...
// File contracts/Solythis.sol

// Original license: SPDX_License_Identifier: MIT
pragma solidity ^0.8.20;


contract Solythis is ERC20, Ownable {
    mapping(address => uint256) private _lockedTokens;

    constructor(address initialOwner) ERC20("Solythis", "LYTH") Ownable(initialOwner) {
        _mint(initialOwner, 1_000_000_000 * (10 ** decimals())); // 1B LYTH Supply
    }
    ...
    function lockTokensForGovernance(uint256 amount) external {
