...
// File contracts/Mintium.sol

// Original license: SPDX_License_Identifier: MIT
pragma solidity ^0.8.20;


contract Mintium is ERC20, Ownable {
    constructor(address initialOwner) ERC20("Mintium", "MNTM") Ownable(initialOwner) {
        _mint(initialOwner, 100_000_000 * (10 ** decimals())); // 100M MNTM Supply
    }
    ...
    function approveNFTMarketplace(address marketplace, uint256 amount) external onlyOwner {
        _approve(address(this), marketplace, amount);
    }

    function spendOnMarketplace(address recipient, uint256 amount) external onlyOwner {
